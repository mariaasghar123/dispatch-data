...
export default function Drop2({heading}) {
  return (
    <div className="w-full mt-20 px-4 sm:px-6 lg:px-10 mb-20" style={{backgroundColor: "#FAF9F3"}}>
      <div className="flex flex-col lg:flex-row custom-flex justify-center items-center gap-10">
        ...
        <div className="w-full md:w-3/5 xl:w-3/5 lg:ml-16 mt-10 lg:mt-0">
          ...
          <div className="border bg-white border-black rounded py-10 px-10 w-full lg:w-3/4 text-sm sm:text-base md:text-lg font-normal">
          ...
          <div className="mt-6 bg-white border border-black rounded py-4 px-10 w-full lg:w-3/4 text-sm sm:text-base md:text-lg font-medium">

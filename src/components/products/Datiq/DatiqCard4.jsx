...
export default function DatiqCard4() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-center gap-10">
        ...
        >
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="font-bold w-5/6 font-archivo text-2xl sm:text-3xl md:text-4xl lg:text-[45px] text-blue-900 leading-snug"
          >
            Network Analytics
          </motion.h2>

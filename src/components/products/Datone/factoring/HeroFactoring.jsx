...
export default function FactoringHero() {
  return (
    <div className="w-full h-[700px] bg-black mx-auto px-4 sm:px-6 md:px-10 lg:px-20 mt-20 py-20">
      <div className="flex flex-col mt-20 lg:flex-row items-center gap-10">
        ...
        >
          <motion.img
            src="/media/images/factoring.jpg"
        ...
        >
          ...
          >
            No more waiting on invoices. Increase your cash flow without burning your bottom line.
          </motion.p>
